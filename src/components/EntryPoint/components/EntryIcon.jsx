...
const EntryIcon = ({ type, style, className }) => {
  if (type === EntryIconTypes.WINDOWS)
    return <Windows className={className} style={style} />;

  if (type === EntryIconTypes.RDP)
    return <Rdp className={className} style={style} />;

  if (type === EntryIconTypes.FTP)
    return <Ftp className={className} style={style} />;

  if (type === EntryIconTypes.SSH)
    return <Ssh className={className} style={style} />;
